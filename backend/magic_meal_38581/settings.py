"""
Django settings for magic_meal_38581 project.
...
ROOT_URLCONF = 'magic_meal_38581.urls'
...
WSGI_APPLICATION = 'magic_meal_38581.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "magic_meal_38581 API",
    "DESCRIPTION": "API documentation for magic_meal_38581 App",
    "VERSION": "v1",
}
